    ...
    <div className="min-h-screen pb-12 relative z-0">
      ...
      <div className="px-5 pt-12 pb-6 flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-black tracking-tight text-white">Leave Appeals</h1>
          <p className="text-xs text-white/70 font-medium">Review and resolve student leave requests</p>
        </div>
      </div>
